...
import { addWishlist, deleteWishlist } from "../../redux/slice/whishlistSlice";
...
const ProductDetails = ({ data }) => {
  ...
  const { product: products } = useSelector((state) => state.allProduct);
  ...
  const addToCartHandler = () => {
    ...
    if (!isItemExists) {
      if (count > data.stock) toast.error("Product stock limited!");
      else {
