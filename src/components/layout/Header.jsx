...
import logo from "../../Assests/logoHashib.png";
...
const Header = () => {
  ...
  const [activeHeading, setActiveHeading] = useNavLink();
  ...
  const handleSearchTerm = (e) => {
    ...
    const fiteredData = product.filter((product) => {
      return product.name.toLowerCase().includes(term.toLowerCase());
    });

    setSearchData(fiteredData);
  };
        ...
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          ...
          <div className="w-[50%] relative">
            <input
              ...
              value={searchTerm}
              // onBlur={() => setSearchTerm("") || setSearchData(null)}
                ...
                {searchData &&
                  searchData.map((i, index) => {
                    return (
                      <Link
                        to={`/product/${i._id}`}
                        onClick={() => setSearchTerm("") || setSearchData([])}
                      >
